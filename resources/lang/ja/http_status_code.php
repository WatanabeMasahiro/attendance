...
return [
  ...
  '404' => [
    ...
    'detail'  => 'サーバーは要求されたリソースを見つけることができなかったことを示します。 URLのタイプミス、非公開、もしくはページが移動または削除された可能性があります。 トップページに戻るか、もう一度検索してください。',
  ],
  '500' => [
    'title'   => '500 Internal Server Error',
    'message' => 'サーバー内部でエラーが発生しました',
    'detail'  => 'プログラムに文法エラーがあったり、設定に誤りがあった場合などに返されます。',
  ],
  '503' => [
